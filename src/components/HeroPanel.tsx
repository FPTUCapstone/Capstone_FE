...
type HeroPanelProps = {
  /** Tiêu đề lớn. Mặc định là nội dung của trang đăng ký. */
  title?: ReactNode;
  /** Đoạn mô tả bên dưới tiêu đề. */
  description?: string;
};
...
export default function HeroPanel({
  title = (
    <>
      Lên kế hoạch <span className="text-brand-brightTeal">du lịch</span> chỉ
      trong vài phút.
    </>
  ),
  ...
  return (
    <aside className="relative hidden lg:flex hero-bg text-white overflow-hidden">
